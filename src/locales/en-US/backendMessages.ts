...
export default {
  ...
  product: {
    ...
    codeTooLong: "Product code exceeds the length limit",
    codeExists: "Product code already exists",
    descriptionTooLong: "Product description exceeds the length limit",
    unitTooLong: "Product unit exceeds the length limit",
    categoryNotFound: "Product category not found",
    statusInvalid: "Product status is invalid",
  },
  productCategory: {
    idRequired: "Product category ID is required",
    notFound: "Product category not found",
    dataChanged: "Product category data has changed. Refresh and try again",
    modifiedAtRequired: "Product category modification time is required",
    deletedAtRequired: "Product category deletion time is required",
    nameRequired: "Product category name is required",
    nameTooLong: "Product category name exceeds the length limit",
    parentIdRequired: "Product category parent ID is required",
    selfCannotBeParent: "A product category cannot be its own parent",
