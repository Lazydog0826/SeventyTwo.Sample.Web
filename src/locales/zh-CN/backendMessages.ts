...
export default {
  ...
  product: {
    ...
    codeRequired: "商品编码不能为空",
    codeTooLong: "商品编码长度超出限制",
    codeExists: "商品编码已存在",
    descriptionTooLong: "商品描述长度超出限制",
    unitTooLong: "商品计量单位长度超出限制",
    categoryNotFound: "商品类目不存在",
    statusInvalid: "商品上架状态无效",
  },
  productCategory: {
    idRequired: "商品类目 ID 不能为空",
    notFound: "商品类目不存在",
    dataChanged: "商品类目数据已变更，请刷新后重试",
    modifiedAtRequired: "商品类目修改时间不能为空",
    deletedAtRequired: "商品类目删除时间不能为空",
    nameRequired: "商品类目名称不能为空",
    nameTooLong: "商品类目名称长度超出限制",
    parentIdRequired: "商品类目上级 ID 不能为空",
    selfCannotBeParent: "商品类目不能作为自身的上级类目",
